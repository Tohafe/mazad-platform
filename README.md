...
### 13. Remote Authentication (OAuth 2.0)
**Worked on by:** `arekoune`

Users can securely log in to the platform using third-party providers such as Google and 42.

### 14. AI Content Moderation
**Worked on by:** `haouky`

The platform uses automated AI moderation to scan user-generated content, automatically filtering inappropriate items, deleting violating content, and issuing user warnings.
...
| Custom-made design system with reusable components       | 1      | A consistent design system improves usability, maintainability, and visual coherence across the platform.                                                          | Implemented through a custom UI layer with reusable components such as buttons, inputs, cards, dialogs, grids, tables, pagination, dropdowns, checkboxes, icons, and layout elements used across the frontend.                   | `All Team Members` |
| Authentication with OAuth 2.0 (Google,42)                | 1      | Enables secure third-party login.                                                                                                                                  | Integrated OAuth 2.0 providers using Spring Security.                                                                                                                                                                            | `arekoune`         |
| Content moderation AI                                    | 1      | Automates platform safety by filtering inappropriate content.                                                                                                      | Implemented AI-based content scanning and automated moderation actions.                                                                                                                                                          | `haouky`           |
**Total Points: 20**
